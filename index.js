...
(async () => {
    const DIR = {
        email: 'bjorg18@eq.edu.au',  // replace YOUR EMAIL with your email for auto login (keep everything else the same)
        password: 'Jorgolove7**',  // replace YOUR PASSWORD with your password for auto login
